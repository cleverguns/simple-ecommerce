              ...
              <div class="card">
                ...
                <div class="card-body table-responsive">
                  <table id="table" class="table table-bordered table-striped text-center">
                    ...
                    <tbody>
                      <?php
                       $tbl_category = $conn->query("SELECT c.category_name as name, c.category_id, COALESCE(COUNT(p.category_id), 0) as total FROM tbl_category c LEFT JOIN tbl_products p ON c.category_id = p.category_id GROUP BY c.category_id ORDER BY c._id DESC");
                       $counter = 0;
                       foreach($tbl_category as $row){
                        ...
                        <tr>
                          ...
                          <td style="white-space: nowrap;">
                            <button data-id="'.$row['category_id'].'" class="btn btn-success mr-2 btn-edit"><i class="fa fa-edit"></i> - Edit</button>
